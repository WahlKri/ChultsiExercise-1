...
"Make a calculator which asks for a two integers and plusses them together. For example "
#Give number a: 
#Give number b: 
#The sum of a and b is result

"Did you encounter any problems? Remember that input() produces raw data format/string. You must somehow turn that "
...
"Use the new way of writing a program that asks for a name, age and birthplace. It should also print the results out"
...
"Make a program that works following way. You can use any structure you want, but the main idea is to ask "
"couple of questions from the user and print them out"
